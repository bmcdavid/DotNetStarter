namespace DotNetStarter.Locators
{
    ...
    /// </summary>
    public abstract class StructureMapSignedLocatorBase : ILocator, ILocatorCreateScope, ILocatorWithPropertyInjection
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public StructureMapSignedLocatorBase(IContainer container = null)
        {
        ...
        {
            return new StructureMapSignedLocatorScoped(_Container.CreateChildContainer(), this);
        }        
    }
}