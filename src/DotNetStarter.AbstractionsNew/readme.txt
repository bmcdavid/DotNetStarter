# DotNetStarter.Abstractions Read Me

This package supports native net3.5+ and netstandard1.3+ and only includes the abstractions. To use DotNetStarter, please use the DotNetStarter or other implementation package.
